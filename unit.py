...
def currency_conversion():
    ...
    units = {"US Dollar" : 'USD', "Euros" : 'EUR', "Indian Rupees" : 'INR', "Qatar Doha" : 'QAR', "Zimbwabe Harare" : 'ZWD', "Arab Emirates Dirham" : 'AED', "Pound Sterling" : 'GBP', "Japanese Yen" : 'JPY', "Yuan Renminbi" : 'CNY'}

    def convert(val, inp, to):
            html =urllib.request.urlopen("http://www.exchangerate-api.com/%s/%s/%f?k=a28d653d2d4fd2727003e437" % (inp , to, val))
...
widget = Button(window, text="Currency Converter", bg="green" , fg="black",font = ("Arial", 14, "bold"), relief = RAISED, bd=5, justify = CENTER, command=currency_conversion).place(x=70,y=60)
